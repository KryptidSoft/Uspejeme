...
Webová aplikace sloužící k rychlému a bezpečnému výpočtu klíčových finančních metrik.

Veškerá data zůstávají v prohlížeči uživatele, což zaručuje 100% soukromí!
...
6. Další nástroje
- Kupní síla: Přepočet CZK na tvrdá aktiva (Zlato, Stříbro, Bitcoin, CHF).
